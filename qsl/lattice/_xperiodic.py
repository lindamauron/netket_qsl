...
class XPeriodic(Kagome):
    '''
    Kagome lattice with X periodicity, thus the length in x-dimension can be anything
    '''
    ...
    def __repr__(self):
        ...
        '''
        return f'Kagome(N={self.N}, X periodicity, dimension={self.xsize, self.ysize})'
    ...
    def construct_vertices(self):
        ...
        self.n_vertices = int(self.N/2 + self.xsize*(self.ysize%2 + 1) ) #CHANGE
        ...
        self.non_border = np.array(non_border, dtype=int)
    ...
    def d(self, i, j):
        ...
        return jnp.min(jnp.array([d1, d3p, d3m])) 
